...
function kalkulator_kredit() {
    ...
    <form action="' . $_SERVER['REQUEST_URI'] . '" method="post">
        <div>
            <label for="pinjaman">Jumlah Pinjaman <strong>*</strong></label>
            <input type="number" name="pinjaman" id="pinjaman">
        </div>
        
        <div>
            <label for="tipe">Perhitungan Bunga <strong>*</strong></label>
            <select name"tipe" id="tipe">
                <option value="anuitas">Anuitas (Angsuran Tetap)</option>
                <option value="efektif">Efektif (Angsuran Menurun)</option>
            </select>
        </div>
        
        <div>
            <label for="jangka">Jangka Waktu <strong>*</strong></label>
        ...
        <div>
            ...
            <input type="text" name="suku_bunga" id="suku-bunga" value="1.75" min="0" step="0.05" max="5">
        </div>
    </form>
    ';
